...
curl -sSL https://dot.net/v1/dotnet-install.sh | bash /dev/stdin --version 5.0.205 --install-dir /opt/dotnet
# Install dotnet for ARM to our project
curl -sSL https://dot.net/v1/dotnet-install.sh | bash /dev/stdin --version 5.0.205 --architecture arm --install-dir ${ROOTFS_DIR}/opt/dotnet
