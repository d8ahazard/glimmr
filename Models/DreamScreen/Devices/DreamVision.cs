...
namespace HueDream.Models.DreamScreen.Devices {
    public class DreamVision : BaseDevice {
        private const string DeviceTag = "DreamVision";
        ...
        public DreamVision() { }
        public DreamVision(string ipAddress) : base(ipAddress) {
            Tag = DeviceTag;
        ...
        [JsonProperty] public int CecPassthroughEnable { get; set; }

        [JsonProperty] public int CecPowerEnable { get; set; }

        [JsonProperty] public int CecSwitchingEnable { get; set; }

        [JsonProperty] public int ColorBoost { get; set; }

        [JsonProperty] public byte[] EspFirmwareVersion { get; set; }

        [JsonProperty] public byte HdmiActiveChannels { get; set; }

        [JsonProperty] public int HdmiInput { get; set; }

        [JsonProperty] public string HdmiInputName1 { get; set; }

        [JsonProperty] public string HdmiInputName2 { get; set; }

        [JsonProperty] public string HdmiInputName3 { get; set; }

        [JsonProperty] public int HdrToneRemapping { get; set; }

        [JsonProperty] public int HpdEnable { get; set; }

        [JsonProperty] public int IndicatorLightAutoOff { get; set; }

        [JsonProperty] public bool IsDemo { get; set; }

        [JsonProperty] public int LetterboxingEnable { get; set; }

        [JsonProperty] private int[] MinimumLuminosity { get; set; }

        [JsonProperty] public int MusicModeSource { get; set; }

        [JsonProperty] public int MusicModeType { get; set; }

        [JsonProperty] public byte[] PicVersionNumber { get; set; }

        [JsonProperty] public int PillarboxingEnable { get; set; }

        [JsonProperty] public int SectorBroadcastControl { get; set; }

        [JsonProperty] public int SectorBroadcastTiming { get; set; }

        [JsonProperty] public int SkuSetup { get; set; }

        [JsonProperty] public int UsbPowerEnable { get; set; }

        [JsonProperty] public int VideoFrameDelay { get; set; }
        ...
        public override void ParsePayload(byte[] payload) {
            ...
            if (name1.Length == 0) name1 = DeviceTag;
            Name = name1;
            ...
            if (payload.Length >= 137) CecPowerEnable = payload[135];
            if (payload.Length >= 138) SkuSetup = payload[136];
            if (payload.Length >= 139) BootState = payload[137];
            if (payload.Length >= 140) PillarboxingEnable = payload[138];
            if (payload.Length >= 141) HdrToneRemapping = payload[139];
        }
